    ...
    <div class="container">
        <div class="messages-listAll">
            ...
            <div class="card text-center">
                ...
                <div id="periodic-refresh8secs-messagesByReport" class="card-body overflow-auto">
                </div>
            </div>
        </div>
    </div>

    <!-- Script src to dynamically load messages by report -->
    <script type="text/javascript" src="../../js/dynamic-load-adminMsgReports.js"></script>
</body>
</html>