...
if (isset($_POST["billings_electricity"]) && $_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($check_existing_Results) <= 0) {
        ...
        $sql_create_payment_record = "INSERT INTO PAYMENTS_ELECTRICITY (tenant_id, charges, payment_by, due_date, to_be_paid_by, date_paid, payment_status)
                                        VALUES 
                                            (
                                                '$tenant_id', 
                                                '$electricity_charges',
        ...
        if (mysqli_query($conn, $sql_create_payment_record)) {
            ...
            try {
                ...
                $sms_msg = "Your monthly electricity billings have been posted!\nCurrent Charges: ".$rental_charges."\n".
            ...
            try {
                notifyThruEmail($tenant_name, $tenant_email, "Electricity", $electricity_charges, $electricity_due_date, $payment_status);
            } catch (ErrorException) {}
        ...
        $sql = "UPDATE PAYMENTS_ELECTRICITY SET 
                            tenant_id = '$tenant_id', 
                            charges = '$electricity_charges',
                            payment_by = '$tenant_name', 
                            due_date = '$electricity_due_date', 
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            try {
                ...
                $sms_msg = "Your monthly electricity billings have been updated!\nCurrent Charges: ".$electricity_charges."\n".
                            "Due Date: ".$electricity_due_date."\n";
            ...
            // Begin to notify the tenant thru Email
            try {
                notifyThruEmail($tenant_name." (Updates)", $tenant_email, "Electricity", $electricity_charges, $electricity_due_date, $payment_status);
            } catch (ErrorException) {}
...
if (isset($_POST["mark-paid-electricity"]) && $_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $_sql_update_payment_stat)) {
        ...
        try {
            ...
            $sms_msg = "Your monthly electricity billings have been acknowledged!";
        ...
        // Begin to notify the tenant thru Email
        try {
            notifyThruEmail($tenant_name." (Paid Acknowledged)", $tenant_email, "Electricity", $electricity_charges, $electricity_due_date, "Paid");
        } catch (ErrorException) {}
